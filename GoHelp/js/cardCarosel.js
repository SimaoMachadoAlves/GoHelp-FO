document.addEventListener('DOMContentLoaded', function () {
  const maxCardsPerCarouselItem = 6; // Número máximo de cartões por item do carrossel
  ...
  function updateMaxCardsPerView(carouselInner) {
      ...
      if (window.innerWidth < 1445) newMaxCards = 4;
      if (window.innerWidth < 992) newMaxCards = 3;
